...
const TR = {"es": {"subject": "Tu enlace de acceso · Unreal Studio", "heading": "Entra a tu portal", "p1": "Has solicitado un enlace de acceso a tu portal de Unreal Studio.", "p2": "Pulsa el botón para entrar. El enlace caduca en 1 hora y solo funciona una vez.", "button": "Entrar a mi portal", "footer": "Si no has sido tú, ignora este correo."}, "en": {"subject": "Your access link · Unreal Studio", "heading": "Enter your portal", "p1": "You have requested an access link to your Unreal Studio portal.", "p2": "Click the button to enter. The link expires in 1 hour and only works once.", "button": "Enter my portal", "footer": "If it wasn't you, ignore this email."}, "ro": {"subject": "Linkul tău de acces · Unreal Studio", "heading": "Intră în portal", "p1": "Ai solicitat un link de acces la portalul tău Unreal Studio.", "p2": "Apasă butonul pentru a intra. Linkul expiră în 1 oră și funcționează doar o dată.", "button": "Intră în portalul meu", "footer": "Dacă nu ai fost tu, ignoră acest e-mail."}, "id": {"subject": "Tautan Akses Anda · Unreal Studio", "heading": "Masuk ke Portal Anda", "p1": "Anda telah meminta tautan akses ke portal Unreal Studio Anda.", "p2": "Klik tombol untuk masuk. Tautan ini akan kedaluwarsa dalam 1 jam dan hanya berfungsi sekali.", "button": "Masuk ke Portal Saya", "footer": "Jika bukan Anda, abaikan surel ini."}};
function tr(lang, key){ const L=(lang||"es").slice(0,2); return (TR[L]&&TR[L][key])||TR.es[key]||key; }
function brandWrap(subject, inner){ return `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@1,300&family=DM+Serif+Display&family=Manrope:wght@400;600;700;800&display=swap" rel="stylesheet"><title>${subject}</title></head><body style="margin:0;padding:0;background:${ALMOND};"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:${ALMOND};padding:28px 16px;"><tr><td align="center"><table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;"><tr><td align="center" style="padding:8px 0 2px;"><span style="font-family:'DM Serif Display',Georgia,serif;font-size:26px;font-weight:700;color:${BROWN};">Unreal Studio</span></td></tr><tr><td align="center" style="padding:0 0 20px;"><span style="font-family:'Cormorant Garamond',Georgia,serif;font-style:italic;font-weight:300;font-size:14px;color:rgba(63,35,5,.55);">Beyond the Ordinary, Inside the Unreal</span></td></tr><tr><td style="background:#fff;border-radius:18px;padding:34px 32px;font-family:Manrope,Arial,sans-serif;color:${BROWN};text-align:justify;">${String(inner).replace(/>\s+</g,"><").trim()}</td></tr><tr><td align="center" style="padding:20px 24px 6px;font-family:Manrope,Arial,sans-serif;"><div style="font-size:12px;color:rgba(63,35,5,.55);">Bali, Indonesia &nbsp;·&nbsp; <a href="mailto:hello@unrealstudiobali.com" style="color:${BROWN};text-decoration:none;font-weight:600;">hello@unrealstudiobali.com</a></div><div style="font-size:10px;color:rgba(63,35,5,.4);line-height:1.8;margin-top:10px;">© 2026 Unreal Studio · Bali</div></td></tr></table></td></tr></table></body></html>`; }
Deno.serve(async (req) => {
  ...
  const redirectTo = p.redirectTo || "https://unrealstudiobali.com/auth/finish";
  ...
  let link="";
  try { const { data, error } = await supabase.auth.admin.generateLink({ type:"magiclink", email, options:{ redirectTo } });
