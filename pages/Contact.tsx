...
const Contact: React.FC = () => {
  useEffect(() => { document.title = 'Contacto | Unreal Studio Madrid'; }, []);
      ...
      <main className="px-6 md:px-12 pt-16 pb-24">
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <p className="text-lg md:text-xl text-primary/70 font-light max-w-2xl mx-auto leading-relaxed">
            Eliminamos la burocracia. Rellena el formulario y te contactaremos por WhatsApp inmediatamente con propuestas concretas.
          </p>
        </div>
          ...
          <div className="lg:col-span-7 bg-white rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-12 shadow-2xl border border-primary/5 relative overflow-hidden">
             ...
             <div className="relative z-10 mb-8">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-2xl md:text-3xl text-primary font-serif">Solicitud Rápida</h2>
                </div>
                <p className="text-sm text-gray-500 font-medium mb-8">
                  Completa tus preferencias. Al enviar, se abrirá tu WhatsApp con la información pre-cargada para nuestro equipo.
                </p>

                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase tracking-widest text-primary/60 ml-1">Nombre Completo</label>
                      <input 
                        type="text" 
                        name="name"
                        required
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase tracking-widest text-primary/60 ml-1">Motivo de Inversión</label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase tracking-widest text-primary/60 ml-1">Rango de Inversión</label>
                       <div className="relative">
                         <select 
                            name="budget"
                    ...
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase tracking-widest text-primary/60 ml-1">Plazo de Inversión</label>
                       <div className="relative">
                         <select 
                            name="timeframe"
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-primary/60 ml-1">Mensaje (Opcional)</label>
                    <textarea 
                      name="message"
                      value={formData.message}
                      onChange={handleChange}
                      placeholder="¿Tienes alguna preferencia de zona o duda específica?"
                      rows={3}
