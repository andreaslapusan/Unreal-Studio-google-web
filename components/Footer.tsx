      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 mb-16 md:mb-20 text-left">
        ...
        <div>
          ...
          <div className="flex space-x-6">
            {/* Instagram */}
            <a
                href="https://instagram.com/unrealstudiobali"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-pink-50 text-pink-600 flex items-center justify-center hover:bg-pink-600 hover:text-white transition duration-300"
