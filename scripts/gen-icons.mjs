...
// Filtro MÍNIMO: Google Fonts ignora los nombres que no son iconos reales, así que
// es mejor incluir de más que excluir un icono legítimo (p.ej. "notifications",
// "dashboard", "list" SON iconos reales y antes se filtraban -> salían como texto).
const BAD = new Set(['outlined', 'rounded', 'sharp']);
