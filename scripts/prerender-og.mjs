...
async function main() {
  ...
  const HOME = [
    { prefix: "en", ogLocale: "en_US", title: "Unreal Studio Bali | Real estate investment in Bali from €75k", desc: "Real estate developer in Bali for international investors. Villas, lofts and apartments in Uluwatu, Canggu and Tabanan from €75,000. Leasehold purchase before a notary, 100% remote with POA. Offices in Madrid & Bali.", alt: "Investment villa in Bali — Unreal Studio" },
    { prefix: "es", ogLocale: "es_ES", title: "Unreal Studio Bali | Inversión inmobiliaria en Bali desde 75k€", desc: "Promotor inmobiliario en Bali para inversores españoles. Villas, lofts y apartamentos en Uluwatu, Canggu y Tabanan desde 75.000€. Compra en leasehold ante notario, 100% remota con POA. Sede en Madrid + Bali.", alt: "Villa de inversión en Bali — Unreal Studio" },
    { prefix: "ro", ogLocale: "ro_RO", title: "Unreal Studio Bali | Investiții imobiliare în Bali de la 75k€", desc: "Dezvoltator imobiliar în Bali pentru investitori internaționali. Vile, lofturi și apartamente în Uluwatu, Canggu și Tabanan de la 75.000€. Achiziție leasehold în fața notarului, 100% la distanță cu POA. Birouri în Madrid și Bali.", alt: "Vilă de investiție în Bali — Unreal Studio" },
    { prefix: "id", ogLocale: "id_ID", title: "Unreal Studio Bali | Investasi properti di Bali mulai €75rb", desc: "Pengembang properti di Bali untuk investor internasional. Vila, loft, dan apartemen di Uluwatu, Canggu, dan Tabanan mulai €75.000. Pembelian leasehold di hadapan notaris, 100% jarak jauh dengan POA. Kantor di Madrid & Bali.", alt: "Vila investasi di Bali — Unreal Studio" },
  ];
  let homeCount = 0;
  for (const h of HOME) {
